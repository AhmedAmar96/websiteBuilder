...
@Component({
  selector: 'app-e-commers',
  templateUrl: './e-commers.component.html',
  styleUrls: ['./e-commers.component.css']
})


export class ECommersComponent implements OnInit {
  ...
  <img src="../../assets/image/temp1.png" class="w-100">
  </div>`
  imgTemp2: any = `<div class="25">
  <img src="../../assets/image/temp2.png" class="w-100">
  </div>`
  imgTemp3: any = `<div class="25">
  <img src="../../assets/image/temp3.png" class="w-100">
  </div>`

  indx: any = "";

  items = [this.imgTemp1, this.imgTemp2];
    ...
    if (this.basket.length == 1) {
      if (event.previousContainer === event.container) {
        ...
        if (this.basket[1] == this.imgTemp1) {
          this.isTemp1 = true;
        } else if (this.basket[1] == this.imgTemp2) {
          this.isTemp2 = true;
        }
